...
6. Set the time zone used in the camera (for exif time).
7. Also change the default folder in line 27.
8Run the script, choose files and wait until they are processed. Enjoy the SQM plot and data saved in *.spc text file.
